        ...
        <div class="sidebar">
            <div class="middle-sidebar">
                <ul class="sidebar-item-list">
                    ...
                    <li>
                        <a href="../student_list/list_student.php"><img class="sidebar-item" src="../../../src/icon/list_student_128px.png" alt="list student" title="List Student"></a>
                    </li>
                    <li>
                        <a href="../supervisor_list/list_supervisor.php"><img class="sidebar-item selected" src="../../../src/icon/list_supervisor_128px.png" alt="list supervisor" title="List Supervisor"></a>
                    </li>
                    <li>
