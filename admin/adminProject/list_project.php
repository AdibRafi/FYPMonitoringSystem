        ...
        <div class="sidebar">
            <div class="middle-sidebar">
                <ul class="sidebar-item-list">
                    ...
                    <li>
                        <a href="verify_project.php"><img class="sidebar-item" src="../../src/icon/verify_project_128px.png" alt="verify project" title="Verify Project"></a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="list_project.php"><img class="sidebar-item selected" src="../../src/icon/project_list_128px.png" alt="list project" title="List Project"></a>
                    </li>
                </ul>
            </div>
