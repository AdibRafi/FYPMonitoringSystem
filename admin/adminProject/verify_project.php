    ...
    <div class="sidebar">
        <div class="middle-sidebar">
            <ul class="sidebar-item-list">
                ...
                <li>
                    <a href="verify_project.php"><img class="sidebar-item selected"
                                                      src="../../src/icon/verify_project_128px.png" alt="list project"
                ...
                <li>
                    <a href="../adminProject/list_project.php"><img class="sidebar-item"
                                                                    ...
                                                                    alt="list project" title="List Project"></a>
                </li>
            </ul>
        </div>
                ...
                <table>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo '<tr onclick="selectRow(this)" id="">
                        <td><input onclick="this.checked = !this.checked;" type="checkbox" name="project[]" id="tableChecked" value="' . $row["PROJ_ID"] . '"></td>
                        <td>' . $row["PROJ_ID"] . '</td>
                        <td>' . $row["NAME"] . '</td>
