    ...
    <div class="container">
        <div class="sidebar">
            ...
            <div class="bottom-sidebar">
                <ul class="sidebar-item-list">
                    <li>
                        <a href="editProfile.php"><img class="sidebar-item" src="../src/icon/edit_profile_128px.png" alt="edit profile icon" title="Edit Profile">
                    </li>
                    <li>
                            ...
                            <h2>
                                <select name="project_id" class="dropdown">
                                    ...
                                    while ($project_arr = mysqli_fetch_assoc($queryProj_result)) {
                                        if (
                                            $project_arr['STUDENT_ID'] === $_SESSION['STUDENT_ID']
