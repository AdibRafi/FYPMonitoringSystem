        ...
        <div class="sidebar">
            <div class="middle-sidebar">
                <ul class="sidebar-item-list">
                    ...
                    <li>
                        <a><img class="sidebar-item selected" src="../src/icon/marking_128px.png" alt="marking icon" title="Mark Sheets"></a>
                    </li>
                </ul>
            </div>
            ...
            <div class="edit-profile-box">
                ...
                <div class="email-row">
                    ...
                    <div class="button-box">
                        <button id="<?= $user_data['PASSWORD'] ?>" onclick=changeEmail(this) class="emailChange" role="button">Change Email
                        </button>
                    </div>
                </div>
                <div class="password-row">
                    <span>Password:
                        ...
                        ?></span>
                    <div class="button-box">
                        <button id="<?= $user_data['PASSWORD'] ?>" onclick=changePassword(this) class="passwordChange" role="button">Change Password
                        </button>
                    </div>
                </div>
            </div>
