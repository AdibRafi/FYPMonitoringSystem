    ...
    <div class="sidebar">
        <div class="middle-sidebar">
            <ul class="sidebar-item-list">
                ...
                <li>
                    <a href="mark_sheets.php"><img class="sidebar-item selected" src="../src/icon/marking_128px.png"
            ...
            <div class="marksheet-box">
                ...
                <div style="padding-bottom: 20px">
                    ...
                    <select name="studentId" id="studentType" onchange="studentProject(this)">
                        ...
                        $sql = "SELECT Student.NAME,Student.STUDENT_ID 
                                FROM Student,Mark 
                                WHERE Student.STUDENT_ID = Mark.STUDENT_ID 
                                and Mark.PATH is not null     
                                and Mark.PERCENTAGE = 0.01
                                and Mark.SUPERVISOR_ID = '".$user_data['SUPERVISOR_ID']."'";
                        ...
                        if ($result->num_rows > 0) {
                            ...
                            echo "<h2>No student submit their project</h2>"
