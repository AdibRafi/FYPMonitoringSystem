    ...
    <div class="sidebar">
        <div class="middle-sidebar">
            <ul class="sidebar-item-list">
                ...
                <li>
                    <a href="#"><img class="sidebar-item" src="../src/icon/student-to-project_assignment_128px.png" alt="student-to-project assignment icon" title="Student-To-Project Assignment"></a>
                </li>
                <li>
